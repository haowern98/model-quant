...
fn quant_type_name(quant_type: &crate::quant::recipe::QuantType) -> &'static str {
    match quant_type {
        ...
        crate::quant::recipe::QuantType::Q5_1 => "Q5_1",
        crate::quant::recipe::QuantType::Q5_0 => "Q5_0",
        crate::quant::recipe::QuantType::Q4_K => "Q4_K",
        crate::quant::recipe::QuantType::Q4_K_M => "Q4_K_M",
        crate::quant::recipe::QuantType::Q4_1 => "Q4_1",
        crate::quant::recipe::QuantType::Q4_0 => "Q4_0",
